void limits_combine_101fb_signals_ppStauR_ionization_tau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:24 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(4.450378e-05);
   Graph_Graph02->SetMaximum(0.0005618446);
   ...
   Graph_Graph13->SetMinimum(6.391235e-05);
   Graph_Graph13->SetMaximum(0.0003690455);
   ...
   Graph_median_expected4->SetMinimum(7.370119e-05);
   Graph_median_expected4->SetMaximum(0.0002951929);
   ...
   Graph_Graph7->SetMaximum(0.001553544);
   ...
   Graph_Graph8->SetMaximum(0.001898776);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.5159216,-1111,0.5159216,0.0001668254);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.5349769,0,0.5349769,0.000139087);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.5299769,0,"  0.53 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.5109216,0,"  0.52 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
