void limits_combine_101fb_signals_ppStau_ionization_tau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:20 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(7.885396e-05);
   Graph_Graph02->SetMaximum(0.001127029);
   ...
   Graph_Graph13->SetMinimum(2.398269e-05);
   Graph_Graph13->SetMaximum(0.0008082718);
   ...
   Graph_median_expected4->SetMinimum(4.457749e-05);
   Graph_median_expected4->SetMaximum(0.0006155535);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6924139,-1111,0.6924139,0.0001317579);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.7118284,0,0.7118284,0.0001133289);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.7068284,0,"  0.71 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6874139,0,"  0.69 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
