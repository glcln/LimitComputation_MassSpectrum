void limits_combine_101fb_signals_Zprime-M600_ssm_ionization_ZPrime()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:29 2024) by ROOT version 6.22/09
   ...
   graph->Draw("l");
   TLine *line = new TLine(4.377853,-1111,4.377853,6.942131e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.532192,0,4.532192,4.944137e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.507192,0,"  4.53 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(4.467853,0,"  4.38 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
