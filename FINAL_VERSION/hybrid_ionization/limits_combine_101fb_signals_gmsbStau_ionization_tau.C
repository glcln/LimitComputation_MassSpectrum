void limits_combine_101fb_signals_gmsbStau_ionization_tau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:34 2024) by ROOT version 6.22/09
   ...
   TH1F *Graph_observed1 = new TH1F("Graph_observed1","observed_title",100,0.1688,1.1072);
   ...
   TH1F *Graph_Graph02 = new TH1F("Graph_Graph02","Graph",100,0.1688,1.1072);
   Graph_Graph02->SetMinimum(5.760992e-05);
   Graph_Graph02->SetMaximum(0.001121753);
   ...
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Graph",100,0.1688,1.1072);
   Graph_Graph13->SetMinimum(5.943477e-05);
   Graph_Graph13->SetMaximum(0.0008062216);
   ...
   TH1F *Graph_median_expected4 = new TH1F("Graph_median_expected4","median_expected_title",100,0.1688,1.1072);
   Graph_median_expected4->SetMinimum(2.280993e-05);
   Graph_median_expected4->SetMaximum(0.0005825202);
   ...
   TH1F *Graph_Graph_observed15 = new TH1F("Graph_Graph_observed15","observed_title",100,0.1688,1.1072);
   ...
   Graph_Graph7->SetMinimum(1.782e-05);
   Graph_Graph7->SetMaximum(0.08711802);
   ...
   Graph_Graph8->SetMinimum(2.178e-05);
   Graph_Graph8->SetMaximum(0.1064776);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.8474499,-1111,0.8474499,8.338149e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("","#sigma^{NNLO+NNLL}_{th}(pp#rightarrow#tilde{#tau}#tilde{#tau}(GMSB))#pm1#sigma","l");
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.863542,0,0.863542,7.326342e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.858542,0,"  0.86 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.8424499,0,"  0.85 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   TH1F *observed_copy__1 = new TH1F("observed_copy__1","observed_title",100,0.1688,1.1072);
