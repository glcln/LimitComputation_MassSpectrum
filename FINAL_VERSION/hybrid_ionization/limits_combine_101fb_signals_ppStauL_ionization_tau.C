void limits_combine_101fb_signals_ppStauL_ionization_tau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:22 2024) by ROOT version 6.22/09
   ...
   Graph_Graph7->SetMaximum(0.004007305);
   ...
   Graph_Graph8->SetMaximum(0.004897817);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.644888,-1111,0.644888,0.0001369309);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.6646556,0,0.6646556,0.0001169954);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.6596556,0,"  0.66 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.639888,0,"  0.64 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
