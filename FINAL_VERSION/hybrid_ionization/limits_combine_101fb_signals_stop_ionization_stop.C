void limits_combine_101fb_signals_stop_ionization_stop()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:13 2024) by ROOT version 6.22/09
   ...
   0.0005155873,
   0.0004503357};
   TGraph *graph = new TGraph(9,observed_fx1,observed_fy1);
   ...
   Graph_observed1->GetXaxis()->SetTitle("m_{#tilde{t}} [TeV]");
   ...
   0.0003688372,
   0.000384048};
   graph = new TGraph(20,Graph0_fx2,Graph0_fy2);
   ...
   Graph_Graph02->SetMinimum(0.0003180279);
   Graph_Graph02->SetMaximum(0.0009142568);
   ...
   0.0003775089,
   0.0003986579};
   graph = new TGraph(20,Graph1_fx3,Graph1_fy3);
   ...
   Graph_Graph13->SetMinimum(0.0003521268);
   Graph_Graph13->SetMaximum(0.0006329767);
   ...
   Double_t median_expected_fx4[9] = {
   1,
   1.2,
   1.4,
   1.6,
   ...
   2.4,
   2.6};
   Double_t median_expected_fy4[9] = {
   0.0004073152,
   0.0003982392,
   0.0004013449,
   0.0004226983,
   ...
   0.0004451922,
   0.0003965406};
   graph = new TGraph(9,median_expected_fx4,median_expected_fy4);
   ...
   Graph_median_expected4->SetMinimum(0.000390208);
   Graph_median_expected4->SetMaximum(0.0004661999);
   ...
   0.0005155873,
   0.0004503357};
   graph = new TGraph(9,observed_fx5,observed_fy5);
   graph->SetName("observed");
   graph->SetTitle("observed_title");
   graph->SetFillStyle(1000);
   graph->SetLineWidth(2);
   ...
   Graph_Graph_observed15->GetXaxis()->SetTitle("m_{#tilde{t}} [TeV]");
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.40353,-1111,1.40353,0.0004630598);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.426177,0,1.426177,0.0004040772);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.401177,0,"  1.43 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.45353,0,"  1.40 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   observed_copy__1->GetXaxis()->SetTitle("m_{#tilde{t}} [TeV]");
