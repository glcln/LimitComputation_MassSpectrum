void limits_combine_101fb_signals_gluino_v1_ionization_gluino()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  2 13:47:11 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0003019952);
   Graph_Graph02->SetMaximum(0.001782664);
   ...
   Graph_Graph13->SetMinimum(0.0003817872);
   Graph_Graph13->SetMaximum(0.001223324);
   ...
   Graph_median_expected4->SetMinimum(0.0004277997);
   Graph_median_expected4->SetMaximum(0.0008780745);
   ...
   graph->Draw("l");
   TLine *line = new TLine(2.047118,-1111,2.047118,0.0007900042);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(2.061251,0,2.061251,0.0007338821);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.036251,0,"  2.06 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.097118,0,"  2.05 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
