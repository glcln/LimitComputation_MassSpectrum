...
iDir = '/opt/sbg/cms/ui6_data1/rhaeberl/CMSSW_11_3_4/src/HSCPLimit/LimitComputation_MassSpectrum/limitTrees_tamas'
...
if not options.blind:
    if 'tau' in cstr:
        ...
        text2.DrawLatex(obsMassLimit-0.015,0, "  %0.2f TeV"%(obsMassLimit))
    elif 'ZPrime' in cstr:
...
climits.SaveAs("asymptotic_ionization/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+".pdf")

climits.SaveAs("asymptotic_ionization/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+".C")

climits.SaveAs("asymptotic_ionization/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+".root")
