...
//=========  (Wed Dec 11 12:28:09 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMaximum(0.0006964995);
   ...
   Graph_Graph13->SetMinimum(2.244432e-05);
   Graph_Graph13->SetMaximum(0.0004777336);
   ...
   Graph_median_expected4->SetMinimum(2.376709e-05);
   Graph_median_expected4->SetMaximum(0.0003178432);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.196252,-1111,1.196252,5.646693e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.177745,0,1.177745,6.243244e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.172745,0,"  1.18 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.246252,0,"  1.20 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
