void limits_combine_101fb_signals_stop_stop()
{
//=========Macro generated from canvas: climits/climits
//=========  (Wed Dec 11 12:28:04 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(6.515965e-05);
   Graph_Graph02->SetMaximum(0.0009758561);
   ...
   Graph_Graph13->SetMinimum(7.649614e-05);
   Graph_Graph13->SetMaximum(0.0006395672);
   ...
   Graph_median_expected4->SetMinimum(0.0002245614);
   Graph_median_expected4->SetMaximum(0.0003002103);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.517699,-1111,1.517699,0.0002329859);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.512326,0,1.512326,0.0002406407);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.487326,0,"  1.51 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.567699,0,"  1.52 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
