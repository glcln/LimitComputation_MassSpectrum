void limits_combine_101fb_signals_ppStauGMSB_tau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Wed Dec 11 12:23:24 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(1.756993e-05);
   Graph_Graph02->SetMaximum(0.002149282);
   ...
   Graph_Graph13->SetMinimum(2.77743e-05);
   Graph_Graph13->SetMaximum(0.001464458);
   ...
   Graph_median_expected4->SetMinimum(4.942749e-05);
   Graph_median_expected4->SetMaximum(0.0009701169);
   ...
   Graph_Graph7->SetMaximum(0.02474802);
   ...
   Graph_Graph8->SetMaximum(0.03024758);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.8502807,-1111,0.8502807,8.150544e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.8775341,0,0.8775341,6.581415e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.8725341,1e-05,"  0.88 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.8702807,1e-05,"  0.85 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
