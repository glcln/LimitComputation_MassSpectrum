void limits_combine_101fb_signals_gluino_hybrid_1p4tev_gluino()
{
//=========Macro generated from canvas: climits/climits
//=========  (Wed Apr  3 18:23:52 2024) by ROOT version 6.22/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(1.0585,-5.021442,2.5885,-0.2186953);
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,1.3,2.5);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,1.3,2.5);
   Graph_Graph12->SetMinimum(1.501152e-05);
   Graph_Graph12->SetMaximum(0.001130606);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,1.3,2.5);
   Graph_Graph23->SetMinimum(0.0001334685);
   Graph_Graph23->SetMaximum(0.0007133335);
   ...
   Double_t Graph3_fx4[1] = {
   1.4};
   Double_t Graph3_fy4[1] = {
   0.0003412628};
   graph = new TGraph(1,Graph3_fx4,Graph3_fy4);
   ...
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","",100,1.3,2.5);
   Graph_Graph34->SetMinimum(0.0003071365);
   Graph_Graph34->SetMaximum(1.100341);
   ...
   Double_t Graph0_fx5[1] = {
   1.4};
   Double_t Graph0_fy5[1] = {
   0.0003236281};
   graph = new TGraph(1,Graph0_fx5,Graph0_fy5);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineWidth(2);
   ...
   TH1F *Graph_Graph_Graph015 = new TH1F("Graph_Graph_Graph015","",100,1.3,2.5);
   ...
   Graph_Graph_Graph015->GetXaxis()->SetTitle("m(#tilde{g}) [TeV]");
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,1.3,2.5);
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,1.3,2.5);
   Graph_Graph7->SetMinimum(0.023004);
   Graph_Graph7->SetMaximum(1.12556);
   ...
   TH1F *Graph_Graph8 = new TH1F("Graph_Graph8","",100,1.3,2.5);
   Graph_Graph8->SetMinimum(0.028116);
   Graph_Graph8->SetMaximum(1.13124);
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,1.3,2.5);
