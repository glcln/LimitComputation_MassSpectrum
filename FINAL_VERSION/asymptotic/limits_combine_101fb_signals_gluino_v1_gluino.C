...
//=========  (Wed Dec 11 12:28:02 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(9.521842e-05);
   Graph_Graph02->SetMaximum(0.002147489);
   ...
   Graph_Graph13->SetMinimum(6.803569e-05);
   Graph_Graph13->SetMaximum(0.001415843);
   ...
   Graph_median_expected4->SetMinimum(0.0002888784);
   Graph_median_expected4->SetMaximum(0.0006775665);
   ...
   graph->Draw("l");
   TLine *line = new TLine(2.128363,-1111,2.128363,0.0005172036);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(2.126901,0,2.126901,0.000521162);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.101901,0,"  2.13 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.178363,0,"  2.13 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
