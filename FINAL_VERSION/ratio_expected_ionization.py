...
def plot_both(name_rootFiles,nameSig,nameLeg):
    strFile1 = "/opt/sbg/cms/ui6_data1/rhaeberl/CMSSW_11_3_4/src/HSCPLimit/LimitComputation_MassSpectrum/FINAL_VERSION/hybrid_ionization/{}".format(name_rootFiles)
    file1 = ROOT.TFile(strFile1,"READ")
    
    strFile2 = "/opt/sbg/cms/ui6_data1/rhaeberl/CMSSW_11_3_4/src/HSCPLimit/LimitComputation_MassSpectrum/FINAL_VERSION/asymptotic_ionization/{}".format(name_rootFiles)
    ...
    object_name2 = "Graph3" 
    #object_name2 = "median_expected" 

    object1 = canvas1.GetPrimitive(object_name)
    object2 = canvas2.GetPrimitive(object_name2)
    object1.SetTitle("") 
    object2.SetTitle("") 
    ...
    nameRoot = "ratios_cls_asymp_ionization/both_median_expected_hybrid_and_asymptotic_{}.root".format(nameLeg)
...
def main():
    ...
    nameSig = ["Z'"]
    nameLeg = ["Zprime"]   
    for i in range(0,len(name_rootFiles)):
