...
//=========  (Tue Apr 23 16:08:50 2024) by ROOT version 6.22/09
   ...
   TH1F *Graph_observed1 = new TH1F("Graph_observed1","observed_title",100,0.29,2.81);
   ...
   Graph_observed1->GetXaxis()->SetRange(21,101);
   ...
   TH1F *Graph_Graph02 = new TH1F("Graph_Graph02","Graph",100,0.29,2.81);
   Graph_Graph02->SetMinimum(1.272126e-05);
   Graph_Graph02->SetMaximum(0.0003625584);
   ...
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Graph",100,0.29,2.81);
   Graph_Graph13->SetMinimum(4.972184e-06);
   Graph_Graph13->SetMaximum(0.0002457022);
   ...
   TH1F *Graph_median_expected4 = new TH1F("Graph_median_expected4","median_expected_title",100,0.29,2.81);
   Graph_median_expected4->SetMinimum(3.778123e-05);
   Graph_median_expected4->SetMaximum(0.0001597737);
   ...
   TH1F *Graph_Graph_observed15 = new TH1F("Graph_Graph_observed15","observed_title",100,0.29,2.81);
   ...
   Graph_Graph_observed15->GetXaxis()->SetRange(21,101);
   ...
   TH1F *observed_copy__1 = new TH1F("observed_copy__1","observed_title",100,0.29,2.81);
   ...
   observed_copy__1->GetXaxis()->SetRange(21,101);
