...
//=========  (Tue Apr 23 16:08:47 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(6.63852e-05);
   Graph_Graph02->SetMaximum(0.00097572);
   ...
   Graph_Graph13->SetMinimum(7.802284e-05);
   Graph_Graph13->SetMaximum(0.0006394284);
   ...
   Graph_median_expected4->SetMinimum(0.0002270439);
   Graph_median_expected4->SetMaximum(0.0002999846);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.517465,-1111,1.517465,0.0002333142);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.511282,0,1.511282,0.0002421567);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.486282,0,"  1.51 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.567465,0,"  1.52 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
