...
//=========  (Thu Apr 25 13:39:56 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(8.478763e-06);
   Graph_Graph02->SetMaximum(0.0001170085);
   ...
   Graph_Graph13->SetMinimum(1.120427e-05);
   Graph_Graph13->SetMaximum(7.241018e-05);
   ...
   Graph_median_expected4->SetMinimum(2.997441e-05);
   Graph_median_expected4->SetMaximum(3.574324e-05);
