...
//=========  (Tue Apr 23 16:09:01 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(1.798016e-05);
   Graph_Graph02->SetMaximum(0.002393113);
   ...
   Graph_Graph13->SetMinimum(2.849708e-05);
   Graph_Graph13->SetMaximum(0.001646188);
   ...
   Graph_median_expected4->SetMinimum(5.003174e-05);
   Graph_median_expected4->SetMaximum(0.00110118);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.8516422,-1111,0.8516422,8.061817e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.8749416,0,0.8749416,6.706022e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.8699416,0,"  0.87 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.8466422,0,"  0.85 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
