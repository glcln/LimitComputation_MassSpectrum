...
#iDir = '/opt/sbg/cms/ui6_data1/rhaeberl/CMSSW_11_3_4/src/HSCPLimit/LimitComputation_MassSpectrum/tst_hybrid_v2/'
...
if not options.blind:
    ...
    print('Blinded')
    g_mclimit.GetXaxis().SetTitle("m_{"+options.particle+"} [TeV]") 
...
if not options.blind:
    g_limit.GetXaxis().SetTitle("m_{"+options.particle+"} [TeV]") 
...
climits.SaveAs("asymptotic/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+"_NoTheo_HybridNew.pdf")
climits.SaveAs("asymptotic/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+"_NoTheo_HybridNew.root")
climits.SaveAs("asymptotic/limits_combine_"+options.lumi.replace('.','p')+"fb_"+options.signals[options.signals.find('/')+1:options.signals.find('.')]+'_'+cstr+"_NoTheo_HybridNew.C")
