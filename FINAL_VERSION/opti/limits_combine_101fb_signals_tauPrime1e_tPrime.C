...
//=========  (Thu Feb  8 17:45:23 2024) by ROOT version 6.22/09
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","",100,0.62,2.78);
   ...
   Graph_Graph01->GetXaxis()->SetTitle("m(#tau'^{1e}) [TeV]");
   Graph_Graph01->GetXaxis()->SetRange(9,101);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",100,0.62,2.78);
   Graph_Graph12->SetMinimum(1.289806e-05);
   Graph_Graph12->SetMaximum(0.0002807456);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",100,0.62,2.78);
   Graph_Graph23->SetMinimum(1.234935e-05);
   Graph_Graph23->SetMaximum(0.0001665968);
   ...
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","",100,0.62,2.78);
   Graph_Graph34->SetMinimum(4.419053e-05);
   Graph_Graph34->SetMaximum(9.318547e-05);
   ...
   TH1F *Graph_Graph_Graph015 = new TH1F("Graph_Graph_Graph015","",100,0.62,2.78);
   ...
   Graph_Graph_Graph015->GetXaxis()->SetTitle("m(#tau'^{1e}) [TeV]");
   Graph_Graph_Graph015->GetXaxis()->SetRange(9,101);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("","#sigma^{NNLO+NNLL}_{th}(pp#rightarrow#tau'^{1e}#tau'^{1e})#pm1#sigma","l");
   ...
   TH1F *Graph_copy = new TH1F("Graph_copy","",100,0.62,2.78);
   ...
   Graph_copy->GetXaxis()->SetTitle("m(#tau'^{1e}) [TeV]");
   Graph_copy->GetXaxis()->SetRange(9,101);
