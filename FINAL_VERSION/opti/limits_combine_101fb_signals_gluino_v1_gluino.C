...
//=========  (Thu Feb  8 17:45:17 2024) by ROOT version 6.22/09
   ...
   Graph_Graph12->SetMinimum(9.717992e-05);
   Graph_Graph12->SetMaximum(0.002147271);
   ...
   Graph_Graph23->SetMinimum(6.961706e-05);
   Graph_Graph23->SetMaximum(0.001415699);
   ...
   Graph_Graph34->SetMinimum(0.0002926647);
   Graph_Graph34->SetMaximum(0.0006772222);
   ...
   graph->Draw("l");
   TLine *line = new TLine(2.128321,-1111,2.128321,0.0005173175);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(2.126503,0,2.126503,0.0005222427);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.101503,0,"  2.13 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.178321,0,"  2.13 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
