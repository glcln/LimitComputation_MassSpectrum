...
//=========  (Fri May 17 17:01:55 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(6.390821e-06);
   Graph_Graph02->SetMaximum(9.984708e-05);
   ...
   Graph_Graph13->SetMinimum(6.451085e-06);
   Graph_Graph13->SetMaximum(5.817931e-05);
   ...
   Graph_median_expected4->SetMinimum(1.672588e-05);
   Graph_median_expected4->SetMaximum(3.199552e-05);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.61872,-1111,1.61872,2.563964e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.677947,0,1.677947,1.918875e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.672947,0,"  1.68 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.66872,0,"  1.62 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
