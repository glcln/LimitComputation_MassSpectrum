...
//=========  (Fri Sep 20 17:14:10 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.000201783);
   Graph_Graph02->SetMaximum(0.0005525094);
   ...
   Graph_Graph13->SetMinimum(0.0002324192);
   Graph_Graph13->SetMaximum(0.0004794499);
   ...
   Graph_median_expected4->SetMinimum(0.0002791524);
   Graph_median_expected4->SetMaximum(0.0004093811);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.472988,-1111,1.472988,0.0003048974);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.471261,0,1.471261,0.0003080814);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.446261,0,"  1.47 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.522988,0,"  1.47 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
