...
//=========  (Sat May  4 17:43:40 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(4.044578e-05);
   Graph_Graph02->SetMaximum(6.675313e-05);
   ...
   Graph_Graph13->SetMinimum(4.174793e-05);
   Graph_Graph13->SetMaximum(5.460355e-05);
   ...
   Graph_median_expected4->SetMinimum(4.302041e-05);
   Graph_median_expected4->SetMaximum(5.37651e-05);
   ...
   graph->Draw("l");
   TLine *line = new TLine(4.020969,-1111,4.020969,4.560587e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("","#sigma^{NNLO+NNLL}_{th}(pp#rightarrowZ'_{#psi}#rightarrow#tau'^{#scale[0.5]{ }2e}#tau'^{#scale[0.5]{ }2e})#pm1#sigma","l");
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.02737,0,4.02737,4.497093e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.00237,0,"  4.03 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(4.110969,0,"  4.02 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
