...
//=========  (Fri Sep 20 17:14:15 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(4.658854e-06);
   Graph_Graph02->SetMaximum(0.000641008);
   ...
   Graph_Graph13->SetMinimum(2.673685e-05);
   Graph_Graph13->SetMaximum(0.0004573532);
   ...
   Graph_median_expected4->SetMinimum(4.39839e-05);
   Graph_median_expected4->SetMaximum(0.0003171497);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.144143,-1111,1.144143,7.492113e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.137817,0,1.137817,7.75376e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.132817,0,"  1.14 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.194143,0,"  1.14 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
