...
//=========  (Fri Sep 20 17:14:12 2024) by ROOT version 6.22/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(0.4011,-6.021442,2.9751,-1.218695);
   ...
   TH1F *Graph_observed1 = new TH1F("Graph_observed1","observed_title",100,0.18,2.82);
   ...
   Graph_observed1->GetXaxis()->SetRange(24,101);
   ...
   TH1F *Graph_Graph02 = new TH1F("Graph_Graph02","Graph",100,0.18,2.82);
   Graph_Graph02->SetMinimum(2.10327e-05);
   Graph_Graph02->SetMaximum(0.0004514714);
   ...
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Graph",100,0.18,2.82);
   Graph_Graph13->SetMinimum(3.801373e-05);
   Graph_Graph13->SetMaximum(0.0003275337);
   ...
   TH1F *Graph_median_expected4 = new TH1F("Graph_median_expected4","median_expected_title",100,0.18,2.82);
   Graph_median_expected4->SetMinimum(5.132304e-05);
   Graph_median_expected4->SetMaximum(0.000230666);
   ...
   TH1F *Graph_Graph_observed15 = new TH1F("Graph_Graph_observed15","observed_title",100,0.18,2.82);
   ...
   Graph_Graph_observed15->GetXaxis()->SetRange(24,101);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.405812,-1111,1.405812,7.267342e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.403707,0,1.403707,7.342587e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.398707,0,"  1.40 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.455812,0,"  1.41 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   TH1F *observed_copy__1 = new TH1F("observed_copy__1","observed_title",100,0.18,2.82);
   ...
   observed_copy__1->GetXaxis()->SetRange(24,101);
