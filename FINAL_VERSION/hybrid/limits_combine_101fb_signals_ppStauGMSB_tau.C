...
//=========  (Fri Sep 20 17:14:29 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(5.303172e-05);
   Graph_Graph02->SetMaximum(0.001997084);
   ...
   Graph_Graph13->SetMinimum(5.262521e-05);
   Graph_Graph13->SetMaximum(0.0014186);
   ...
   Graph_median_expected4->SetMinimum(5.563494e-05);
   Graph_median_expected4->SetMaximum(0.000972788);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.844286,-1111,0.844286,8.552947e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.870451,0,0.870451,6.930522e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.865451,0,"  0.87 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.839286,0,"  0.84 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
