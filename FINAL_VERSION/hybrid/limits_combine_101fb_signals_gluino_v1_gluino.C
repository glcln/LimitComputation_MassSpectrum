...
//=========  (Fri Sep 20 17:14:08 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0001772377);
   Graph_Graph02->SetMaximum(0.001244774);
   ...
   Graph_Graph13->SetMinimum(0.0002601796);
   Graph_Graph13->SetMaximum(0.001097882);
   ...
   Graph_median_expected4->SetMinimum(0.0003307373);
   Graph_median_expected4->SetMaximum(0.0009145421);
   ...
   graph->Draw("l");
   TLine *line = new TLine(2.080381,-1111,2.080381,0.0006642168);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(2.07836,0,2.07836,0.0006712547);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.05336,0,"  2.08 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.130381,0,"  2.08 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
