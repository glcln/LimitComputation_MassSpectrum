...
//=========  (Fri Mar 15 10:39:50 2024) by ROOT version 6.22/09
   ...
   Graph_Graph12->SetMinimum(0.0003049353);
   Graph_Graph12->SetMaximum(0.0006425324);
   ...
   Graph_Graph23->SetMinimum(0.0003704544);
   Graph_Graph23->SetMaximum(0.0005071811);
   ...
   Double_t Graph0_fx4[1] = {
   1.4};
   Double_t Graph0_fy4[1] = {
   0.0004347516};
   graph = new TGraph(1,Graph0_fx4,Graph0_fy4);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph_Graph014 = new TH1F("Graph_Graph_Graph014","",100,1.3,2.5);
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","",100,1.3,2.5);
   ...
   Graph_Graph6->SetMinimum(0.023004);
   Graph_Graph6->SetMaximum(1.12556);
   ...
   Graph_Graph7->SetMinimum(0.028116);
   Graph_Graph7->SetMaximum(1.13124);
