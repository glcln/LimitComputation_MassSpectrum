...
//=========  (Fri Sep 20 17:14:17 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMaximum(0.001965271);
   ...
   Graph_Graph13->SetMaximum(0.00140028);
   ...
   Graph_median_expected4->SetMaximum(0.0009817787);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6371988,-1111,0.6371988,0.0002038938);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.7535479,0,0.7535479,8.239703e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.7485479,0,"  0.75 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6321988,0,"  0.64 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
