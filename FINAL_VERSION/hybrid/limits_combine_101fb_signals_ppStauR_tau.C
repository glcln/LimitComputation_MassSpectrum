...
//=========  (Fri Sep 20 17:14:21 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(4.736269e-05);
   Graph_Graph02->SetMaximum(0.115918);
   ...
   Graph_Graph13->SetMinimum(5.211358e-05);
   Graph_Graph13->SetMaximum(0.08341282);
   ...
   Graph_median_expected4->SetMinimum(5.87393e-05);
   Graph_median_expected4->SetMaximum(0.05732132);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.2927687,-1111,0.2927687,0.001952576);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.2973192,0,0.2973192,0.00182926);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.2923192,0,"  0.30 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.2877687,0,"  0.29 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
