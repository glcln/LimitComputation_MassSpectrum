void ZPrimeTPrime_2DLimit_massMethod_hybrid()
{
//=========Macro generated from canvas: FinalCurves/FinalCurves
//=========  (Tue May 21 09:45:06 2024) by ROOT version 6.22/09
   ...
   TGraph2D *graph2d = new TGraph2D(34);
   graph2d->SetName("upperLimit");
   graph2d->SetTitle("Graph2D;;;");
   graph2d->SetPoint(0,200,3000,4.711486e-05);
   graph2d->SetPoint(1,400,3000,4.708861e-05);
   graph2d->SetPoint(2,600,3000,5.096522e-05);
   graph2d->SetPoint(3,1000,3000,4.944211e-05);
   graph2d->SetPoint(4,1200,3000,5.626223e-05);
   graph2d->SetPoint(5,1400,3000,0.002761769);
   graph2d->SetPoint(6,200,4000,4.51325e-05);
   graph2d->SetPoint(7,400,4000,4.53081e-05);
   graph2d->SetPoint(8,600,4000,4.520008e-05);
   graph2d->SetPoint(9,800,4000,3.202638e-05);
   graph2d->SetPoint(10,1000,4000,4.346155e-05);
   graph2d->SetPoint(11,1200,4000,4.342831e-05);
   graph2d->SetPoint(12,1400,4000,4.4343e-05);
   graph2d->SetPoint(13,200,5000,4.841567e-05);
   graph2d->SetPoint(14,400,5000,4.748984e-05);
   graph2d->SetPoint(15,600,5000,4.484186e-05);
   graph2d->SetPoint(16,800,5000,4.332124e-05);
   graph2d->SetPoint(17,1000,5000,4.566678e-05);
   graph2d->SetPoint(18,1200,5000,4.434032e-05);
   graph2d->SetPoint(19,1400,5000,4.494357e-05);
   graph2d->SetPoint(20,200,6000,5.506474e-05);
   graph2d->SetPoint(21,400,6000,5.165609e-05);
   graph2d->SetPoint(22,600,6000,5.048879e-05);
   graph2d->SetPoint(23,800,6000,4.974099e-05);
   graph2d->SetPoint(24,1000,6000,5.069499e-05);
   graph2d->SetPoint(25,1200,6000,4.924855e-05);
   graph2d->SetPoint(26,1400,6000,4.876946e-05);
   graph2d->SetPoint(27,200,7000,6.917327e-05);
   graph2d->SetPoint(28,400,7000,5.500986e-05);
   graph2d->SetPoint(29,600,7000,5.409011e-05);
   graph2d->SetPoint(30,800,7000,4.958839e-05);
   graph2d->SetPoint(31,1000,7000,4.578215e-05);
   graph2d->SetPoint(32,1200,7000,5.459161e-05);
   graph2d->SetPoint(33,1400,7000,5.417148e-05);
