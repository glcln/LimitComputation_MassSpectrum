...
if __name__ == '__main__':
    ...
    pathPred = "/opt/sbg/cms/ui3_data1/gcoulon/HSCP_prod/SingleMuon/Syst_KC_forCaro/"
    ...
    if(DoAllSignals):
        ...
        fpath['pairStau1218_2018'] = pathSignal+'HSCPpairStau_V'+codeVersionSignal+'/HSCPpairStau_M-1218_merged.root'
        fpath['pairStau1409_2018'] = pathSignal+'HSCPpairStau_V'+codeVersionSignal+'/HSCPpairStau_M-1409_merged.root'
        fpath['pairStau1599_2018'] = pathSignal+'HSCPpairStau_V'+codeVersionSignal+'/HSCPpairStau_M-1599_merged.root'
        '''
        ...
        fpath['DYcharge1e_400_2018'] = pathSignal+'HSCPtauPrimeCharge1e_V'+codeVersionSignal+'/HSCPtauPrimeCharge1e_M-400_merged.root'
        ...
        fpath['DYcharge2e_100_2018'] = pathSignal+'HSCPtauPrimeCharge2e_V'+codeVersionSignal+'/HSCPtauPrimeCharge2e_M-100_merged.root'
        ...
        fpath['DYcharge2e_800_2018'] = pathSignal+'HSCPtauPrimeCharge2e_V'+codeVersionSignal+'/HSCPtauPrimeCharge2e_M-800_merged.root'
        fpath['DYcharge2e_1000_2018'] = pathSignal+'HSCPtauPrimeCharge2e_V'+codeVersionSignal+'/HSCPtauPrimeCharge2e_M-1000_merged.root'
    ...
    name = {
        'Gluino100_2018': '$\\tilde{g}$ (M=100 GeV)',
        'Gluino200_2018': '$\\tilde{g}$ (M=200 GeV)',
        'Gluino400_2018': '$\\tilde{g}$ (M=400 GeV)',
        ...
        'Stop100_2018': '$\\tilde{t}$ (M=100 GeV)',
        'Stop200_2018': '$\\tilde{t}$ (M=200 GeV)',
        ...
        'pairStau1218_2018': '$\\tilde{\\tau}$ (M=1218 GeV)',
        'pairStau1409_2018': '$\\tilde{\\tau}$ (M=1409 GeV)',
        'pairStau1599_2018': '$\\tilde{\\tau}$ (M=1599 GeV)',
        ...
        'gmsbStau1218_2018': '$\\tilde{\\tau}_{GMSB}$ (M=1218 GeV)',
        'gmsbStau1409_2018': '$\\tilde{\\tau}_{GMSB}$ (M=1409 GeV)',
        'gmsbStau1599_2018': '$\\tilde{\\tau}_{GMSB}$ (M=1599 GeV)',
    ...
    target={
       ...
       'pairStau1218_2018': 1218,
       'pairStau1409_2018': 1409,
       'pairStau1599_2018': 1599,
    ...
    outDataCardsDir = "datacards_"+searchRegion+"_Test_SystK1C1_codeChanged/"
    ...
    for signal in fpath.keys():
        ...
        ofileSignal_name = outDataCardsDir+signal+".root"
...
#
        ...
        if(signal_yield!=0):
            ...
            #-----
            signal_C_up = 2*(signal_C_up-1) + 1 
            signal_C_down = 1 - 2*(1-signal_C_down) 
            #-----
            if(Add_SysMuon):
