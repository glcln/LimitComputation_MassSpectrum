...
//=========  (Tue Jun 24 10:58:15 2025) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0004984768);
   Graph_Graph02->SetMaximum(0.005370217);
   ...
   Graph_Graph13->SetMinimum(0.001081451);
   Graph_Graph13->SetMaximum(0.003281922);
   ...
   Graph_median_expected4->SetMinimum(0.001736554);
   Graph_median_expected4->SetMaximum(1.10193);
