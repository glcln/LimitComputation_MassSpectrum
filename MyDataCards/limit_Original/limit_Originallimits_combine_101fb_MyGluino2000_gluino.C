void limit_Originallimits_combine_101fb_MyGluino2000_gluino()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jun 24 13:24:04 2025) by ROOT version 6.22/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(1.67875,-5.021442,3.07375,-0.2186953);
   ...
   Double_t observed_fx1[1] = {
   2};
   Double_t observed_fy1[1] = {
   0.0007814663};
   TGraph *graph = new TGraph(1,observed_fx1,observed_fy1);
   ...
   TH1F *Graph_observed1 = new TH1F("Graph_observed1","observed_title",100,1.9,3.1);
   ...
   Graph_observed1->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph0_fx2[4] = {
   2,
   2,
   2,
   2};
   Double_t Graph0_fy2[4] = {
   0.002399418,
   0.002399418,
   0.0002280884,
   0.0002280884};
   graph = new TGraph(4,Graph0_fx2,Graph0_fy2);
   ...
   TH1F *Graph_Graph02 = new TH1F("Graph_Graph02","Graph",100,1.9,3.1);
   Graph_Graph02->SetMinimum(1.095547e-05);
   Graph_Graph02->SetMaximum(0.00261655);
   ...
   Double_t Graph1_fx3[4] = {
   2,
   2,
   2,
   2};
   Double_t Graph1_fy3[4] = {
   0.001587953,
   0.001587953,
   0.0004033928,
   0.0004033928};
   graph = new TGraph(4,Graph1_fx3,Graph1_fy3);
   ...
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Graph",100,1.9,3.1);
   Graph_Graph13->SetMinimum(0.0002849368);
   Graph_Graph13->SetMaximum(0.001706409);
   ...
   Double_t median_expected_fx4[1] = {
   2};
   Double_t median_expected_fy4[1] = {
   0.0007890625};
   graph = new TGraph(1,median_expected_fx4,median_expected_fy4);
   ...
   TH1F *Graph_median_expected4 = new TH1F("Graph_median_expected4","median_expected_title",100,1.9,3.1);
   Graph_median_expected4->SetMinimum(0.0007101563);
   Graph_median_expected4->SetMaximum(1.100789);
   ...
   Double_t observed_fx5[1] = {
   2};
   Double_t observed_fy5[1] = {
   0.0007814663};
   graph = new TGraph(1,observed_fx5,observed_fy5);
   graph->SetName("observed");
   graph->SetTitle("observed_title");
   graph->SetFillStyle(1000);
   graph->SetLineWidth(2);
   ...
   TH1F *Graph_Graph_observed15 = new TH1F("Graph_Graph_observed15","observed_title",100,1.9,3.1);
   ...
   Graph_Graph_observed15->GetXaxis()->SetRange(0,92);
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,1.9,3.1);
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,1.9,3.1);
   Graph_Graph7->SetMinimum(0.0008181);
   Graph_Graph7->SetMaximum(1.100909);
   ...
   TH1F *Graph_Graph8 = new TH1F("Graph_Graph8","",100,1.9,3.1);
   Graph_Graph8->SetMinimum(0.0009999);
   Graph_Graph8->SetMaximum(1.101111);
   ...
   graph->Draw("l");
   TLine *line = new TLine(-1,-1111,-1,-1);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(-1.025,0,"  -1.00 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(-0.95,0,"  -1.00 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   TH1F *observed_copy__1 = new TH1F("observed_copy__1","observed_title",100,1.9,3.1);
   ...
   observed_copy__1->GetXaxis()->SetRange(0,92);
