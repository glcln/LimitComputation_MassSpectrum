...
//=========  (Fri Dec 13 15:43:31 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0003519694);
   Graph_Graph02->SetMaximum(0.001966635);
   ...
   Graph_Graph13->SetMinimum(0.0005814699);
   Graph_Graph13->SetMaximum(0.001360084);
   ...
   Graph_median_expected4->SetMinimum(0.0008093979);
   Graph_median_expected4->SetMaximum(1.100899);
