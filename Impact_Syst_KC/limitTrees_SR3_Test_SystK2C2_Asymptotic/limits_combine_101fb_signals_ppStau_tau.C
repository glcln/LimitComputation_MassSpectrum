...
//=========  (Wed Dec 11 12:37:49 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMaximum(0.002330763);
   ...
   Graph_Graph13->SetMaximum(0.001537557);
   ...
   Graph_median_expected4->SetMaximum(0.0009987441);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6391473,-1111,0.6391473,0.0002006037);
   line->SetLineStyle(2);
   line->Draw();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6591473,1e-05,"  0.64 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
