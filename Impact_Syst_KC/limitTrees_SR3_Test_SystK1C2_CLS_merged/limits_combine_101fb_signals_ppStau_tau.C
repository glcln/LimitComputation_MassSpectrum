...
//=========  (Fri Dec 13 15:43:09 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0003578213);
   Graph_Graph02->SetMaximum(0.001943327);
   ...
   Graph_Graph13->SetMinimum(0.000575507);
   Graph_Graph13->SetMaximum(0.001360015);
   ...
   Graph_median_expected4->SetMinimum(0.0007986209);
   Graph_median_expected4->SetMaximum(1.100887);
