...
//=========  (Wed Dec 11 12:38:25 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMaximum(0.002145306);
   ...
   Graph_Graph13->SetMaximum(0.001459495);
   ...
   Graph_median_expected4->SetMaximum(0.000968098);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6392072,-1111,0.6392072,0.0002005034);
   line->SetLineStyle(2);
   line->Draw();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6592072,1e-05,"  0.64 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
