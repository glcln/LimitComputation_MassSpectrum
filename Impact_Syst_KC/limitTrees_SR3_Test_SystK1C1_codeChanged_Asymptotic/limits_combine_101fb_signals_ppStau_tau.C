...
//=========  (Wed Dec 11 12:38:35 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(1.72267e-05);
   Graph_Graph02->SetMaximum(0.002165571);
   ...
   Graph_Graph13->SetMinimum(2.78331e-05);
   Graph_Graph13->SetMaximum(0.001468528);
   ...
   Graph_median_expected4->SetMinimum(4.955095e-05);
   Graph_median_expected4->SetMaximum(0.0009728128);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6392035,-1111,0.6392035,0.0002005096);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(0.757006,0,0.757006,8.03786e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.752006,1e-05,"  0.76 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6592035,1e-05,"  0.64 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
