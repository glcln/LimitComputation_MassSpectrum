...
//=========  (Fri Dec 13 15:42:36 2024) by ROOT version 6.22/09
   ...
   Graph_Graph02->SetMinimum(0.0003359193);
   Graph_Graph02->SetMaximum(0.002141913);
   ...
   Graph_Graph13->SetMinimum(0.0005583112);
   Graph_Graph13->SetMaximum(0.001478391);
   ...
   Graph_median_expected4->SetMinimum(0.0008388419);
   Graph_median_expected4->SetMaximum(1.100932);
