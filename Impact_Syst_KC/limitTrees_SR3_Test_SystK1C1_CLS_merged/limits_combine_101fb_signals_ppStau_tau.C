...
//=========  (Fri Dec 13 15:41:31 2024) by ROOT version 6.22/09
   TCanvas *climits = new TCanvas("climits", "climits",0,0,700,600);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   climits->SetHighLightColor(2);
   climits->Range(-0.03350001,-6.021442,1.4965,-1.218695);
   ...
   TH1F *Graph_observed1 = new TH1F("Graph_observed1","observed_title",100,0.208,1.408);
   ...
   TH1F *Graph_Graph02 = new TH1F("Graph_Graph02","Graph",100,0.208,1.408);
   Graph_Graph02->SetMinimum(0.0003684664);
   Graph_Graph02->SetMaximum(0.001914441);
   ...
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Graph",100,0.208,1.408);
   Graph_Graph13->SetMinimum(0.0005849852);
   Graph_Graph13->SetMaximum(0.001355007);
   ...
   TH1F *Graph_median_expected4 = new TH1F("Graph_median_expected4","median_expected_title",100,0.208,1.408);
   Graph_median_expected4->SetMinimum(0.0008025776);
   Graph_median_expected4->SetMaximum(1.100892);
   ...
   TH1F *Graph_Graph_observed15 = new TH1F("Graph_Graph_observed15","observed_title",100,0.208,1.408);
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","",100,0.2359,1.1011);
   ...
   TH1F *Graph_Graph7 = new TH1F("Graph_Graph7","",100,0.2359,1.1011);
   Graph_Graph7->SetMinimum(9.464489e-06);
   Graph_Graph7->SetMaximum(0.005560738);
   ...
   TH1F *Graph_Graph8 = new TH1F("Graph_Graph8","",100,0.2359,1.1011);
   Graph_Graph8->SetMinimum(1.156771e-05);
   Graph_Graph8->SetMaximum(0.006796458);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(-1.005,0,"  -1.00 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   TH1F *observed_copy__1 = new TH1F("observed_copy__1","observed_title",100,0.208,1.408);
